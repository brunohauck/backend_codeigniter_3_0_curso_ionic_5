...
class Employee extends CI_Controller {
  ...
  public function get_like($val){
		$employees = $this->employee->get_like($val);
		$response["results"] = array();
		foreach($employees as $emp){
			$employee = array();
			$employee["name"] = $emp->first_name;
      $employee["latest"] = "https://cdnjs.cloudflare.com/ajax/libs/utf8/3.0.0/utf8.min.js";
 			array_push($response["results"], $employee);
		}
		echo json_encode($response);
	}
